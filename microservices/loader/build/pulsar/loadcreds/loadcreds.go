...
//Ingest user credentials to a REDIS table for consumers worker pods to login
//to the API with.
...
var credentialsDBindex int = 14 //Index of the REDIS DB to store user credentials in
...
func main() {
	...
	used := 0 //marked as "unused" ("un-read")
